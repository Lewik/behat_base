#language: ru
Функционал: Проверка заполнения и согласования закупки минимальным количеством полей
  Сценарий: Проверка заполнения и согласования закупки минимальным количеством полей
    #Вход
